...
class CreateFunctions extends Migration
{
    public function up()
    {
        $this->createFunction('fn_acornassociated_calendar_seed', 
            array(), 
            'void', 
            array(),
        <<<SQL
...
SQL
        ...
        $this->createFunction('fn_acornassociated_calendar_create_event', array(
                'calendar_id uuid',
                'owner_user_id uuid',
                'event_type_id uuid',
...
SQL
        ...
        $this->createFunction('fn_acornassociated_calendar_lazy_create_event', array(
...
SQL
        ...
        $this->createFunction('fn_acornassociated_calendar_trigger_activity_event', array(),
            'trigger', 
            array(
...
SQL
    ...
    public function down()
    {
        ...
        // Schema::dropIfExists('fn_acornassociated_calendar_create_event');
        // Schema::dropIfExists('fn_acornassociated_calendar_create_event');
        // Schema::dropIfExists('fn_acornassociated_calendar_lazy_create_event');
        // Schema::dropIfExists('fn_acornassociated_calendar_create_activity_log_event');
        // Schema::dropIfExists('fn_acornassociated_calendar_trigger_activity_event');
    }
}
